...
class BusinessdaySpider(scrapy.Spider):
    """
    ...
    # The URL the spider begins crawling from, two are used in this spider
    start_urls = ['https://businessday.ng/category/health/',
                  'https://businessday.ng/category/health/page/2/']
    ...
    custom_settings = {
        ...
        "FEEDS": {
            "./HealthNewsScraper/scrapes/businessday.jl": {"format": "jsonlines"}
        },
    }
    ...
    def parse(self, response):
        ...
        # To get the full page information
    ...
    def scrape(self, response):
        ...
        # A loop that goes through every news post and retrieves the individual news' link
        for news_card in response.css("h2.title"):
    ...
    def news_reader(response):
        ...
        article = response.css("article.post.type-post")
        ...
        news_item_loader.add_css('title', 'h1.single-post-title span::text')
